...
public class Dashboard extends JFrame {
        ...
        private void initComponents() {
            ...
            int qty = Integer.parseInt(spinner.g
                if (qtyIsZero(qty) && checkBox.isS
                     x++;
                // 
                 ...
                 * ffeeShop();
                    ...
                    d
                        total += price;
                                = calculator.calculateTax(total);
                                        a.setText(jTextArea.getText() + x + ". " + lab
                                        ;
                                
                        c
                }
                        
                ate void jCheckBox1ActionPerformed(ja
                        oxAction(jCheckBox1, jSpinner1, jLabelProduk1, 0);
                
                        eckBox2ActionPerformed(java.awt.event.ActionEvent evt
                handleCheckBoxAction(jCheckBox2, jSpinner2, jL
                        
                a
                ha ndleCheckBoxAc

                
                ate void jCheckBox4ActionPerformed(java
                        leCheckBoxAction(jC
